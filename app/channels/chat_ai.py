        ...
        try:
            response = await self.client.responses.parse(
                ...
                instructions=(
                    ...
                    "Never merge two products, their photos, or their listing details into one "
                    "item. Preserve every distinct product mention in pass_through text so the "
                    "deterministic item guard can separate it. "
                    ...
                    "a question or casual message that does not advance the workflow. Replies "
                    "sound like a friendly, helpful person texting: warm, relaxed, concise, and "
                    "in natural "
                    "sentence case. Use a quick acknowledgment such as 'Got it' or 'Sounds good' "
                    "when it fits, but do not repeat greetings. Keep replies to one short "
                    "sentence, "
                    "or two at most, with no lists and no promise of an unsupported marketplace "
                    "action. Use "
